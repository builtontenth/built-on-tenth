...
heroImageAlt: "Person on phone at desk handling customer service calls"
readTime: 12
featured: false
seoKeywords: ["hvac csr training", "hvac phone booking rate", "hvac call center performance", "hvac csr losing sales", "hvac phone answer rate"]
---
...
Here's what the data shows: according to [Hatch](https://www.usehatchapp.com/blog/hvac-speed-to-lead-response-rates), which has analyzed over 1 million contractor call interactions, the average HVAC company answers roughly **68% of inbound calls** and books around **42% of the calls they answer**. Follow-up on unbooked calls? Less than 20%.
...
![HVAC dispatcher reviewing scheduling board and call logs at office workstation](https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=1200&q=80)
...
[Hatch's research on contractor call performance](https://www.usehatchapp.com/blog/hvac-speed-to-lead-response-rates) found that **78% of consumers go with the business that reaches out to them first** — and that it takes an average of 8 touches to engage a decision maker. Yet most HVAC companies make zero follow-up attempts after an unbooked call.
...
3. If no answer, a text follows: *"Hi [name], this is [company]. You called earlier about your AC — just checking you got taken care of. We have openings tomorrow if you still need help."*
4. Second follow-up at 24 hours if still no response
5. Two touches, done. No harassment. Just two more chances to serve someone who already raised their hand.
...
Options at different price points: [CallRail](https://callrail.com) ($45/month), WhatConverts ($30/month), or your existing platform — ServiceTitan, Housecall Pro, and Jobber all have call recording built in.
...
1. **Get call tracking running** — even a free trial of CallRail. Pull your answer rate for the last 30 days.

2. **Listen to 10 call recordings** — specifically calls that didn't result in a booking. Count how many times your CSR asked for the appointment versus waited for the customer to volunteer.

3. **Use our free Phone Revenue Calculator** — enter your call volume, answer rate, and average ticket. See the dollar figure your current phone system is costing you monthly.

4. **Write one sentence** — the transition your CSR uses to move from answering questions to asking for the time slot. Test it this week.
