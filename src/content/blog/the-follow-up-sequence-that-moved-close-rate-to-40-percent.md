---
title: "The Follow-Up Sequence That Moved a 15% Close Rate to 40%"
seoTitle: "Estimate Follow-Up Sequence for Contractors | Built on Tenth"
...
metaDescription: "Use this contractor estimate follow-up sequence to improve close rate with structured calls, texts, timing, and scripts."
...
- **Average follow-up attempts after a sent estimate: 0.6**
- That means most companies make less than one follow-up attempt
...
This is a CSR and office operations problem before it's a sales problem. The [CSR performance breakdown](/insights/why-hvac-csrs-are-losing-you-300k-per-year) covers how much unworked estimates and slow response times cost per year in dollar terms -- the math is built around inbound calls but the same mechanics apply to estimate follow-up.
...
| Metric | Before | After |
|---|---|---|
| Estimates sent per month | 90 | 90 |
| Close rate | 15% | 41% |
| Jobs closed per month | 13 | 37 |
...
| Homeowner | Estimate Date | Estimate $ | T1 (2hr call) | T2 (4hr text) | T3 (48hr call) | T4 (7d text) | Outcome |
|---|---|---|---|---|---|---|---|
| [name] | [date] | [amount] | Y / N | Y / N | Y / N | Y / N | Booked / Lost / No response |
