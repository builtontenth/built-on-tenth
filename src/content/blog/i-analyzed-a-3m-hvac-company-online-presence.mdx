...
If you want this same kind of teardown done on your city and your actual competitors, the [HVAC Local Market Report](/report) is built for exactly that use case. Same public-market lens, but applied to your own local map pack and call gap.
...
If you want the written version of this process without doing all the public-data work yourself, [request your HVAC Local Market Report](/report). If you want to keep reading comparisons first, [browse all HVAC Market Insights](/insights).

The [Website Conversion Scorecard](/tools/website-audit) runs the PageSpeed and basic conversion checks automatically. Start there, then layer in the manual steps above.
...
1. **Run your own scorecard** -- use the [Website Conversion Scorecard](/tools/website-audit) to pull your PageSpeed score and check the basics in 30 seconds.
